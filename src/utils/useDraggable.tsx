...
export default function useDragList({
    ...
    const calculateNewPositions = (
        ...
        elementsToMove.forEach((element, index) => {
            ...
            element.node.style.transform = `translate3d(${translate.x}px, ${translate.y
                }px, 0px)`
    ...
    const onMove = (e: any) => {
        ...
        currentTarget.node.style.transform = `translate3d(${translate.x}px, ${translate.y
            }px, 0)`
    ...
    const getItemProps = (id: string) => {
        return {
            ...
            [eventListeners.onEnd]: (e: any) => {
                ...
                currentTarget.node.style.transform = `translate3d(${newTranslatePosition.x
